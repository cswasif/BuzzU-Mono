  ...
  return (
    <div className="chat-page">
      ...
      <div className="status-bar">
        ...
        <span className="encryption-badge">🔗 P2P Direct</span>
        {/* Note: this legacy page uses direct P2P chat without Signal-protocol E2E encryption.
                    Use /chat/new for the full encrypted dashboard experience. */}
      </div>
