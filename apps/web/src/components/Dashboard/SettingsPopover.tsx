...
const SettingsPopover: React.FC<SettingsPopoverProps> = ({ theme, onToggleTheme }) => {
  ...
  return (
    ...
    >
      ...
      <a href="https://www.chitchat.gg/privacy-policy" target="_blank" rel="noreferrer" className="inline-flex disabled:select-none items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 py-2 w-full justify-between px-1">
        <span className="flex flex-row gap-2">
      ...
      <a href="https://www.chitchat.gg/terms" target="_blank" rel="noreferrer" className="inline-flex disabled:select-none items-center rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 py-2 w-full justify-between px-1">
        <span className="flex flex-row gap-2">
          <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
