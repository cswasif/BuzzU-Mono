            ...
            >
                ...
                <div>
                    <div className="flex flex-wrap gap-2 bg-muted rounded-md p-2 py-4 mb-4">
                        <input className="w-32 select-auto sm:text-sm text-sm rounded-md bg-popover dark:bg-placeholder p-1 focus-visible:outline-none inline-flex" maxLength={32} placeholder="Add an interest..." type="text" />
                    </div>
                                ...
                                <div className="flex flex-col w-full animate-in fade-in slide-in-from-right-4 duration-200">
                                    ...
                                    <div className="flex w-full gap-1 min-w-full justify-between items-center py-1 pb-2">
                                        ...
                                        <div className="flex flex-row gap-1">
                                            ...
                                            <button className="inline-flex disabled:select-none items-center justify-center text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-secondary text-secondary-foreground hover:bg-secondary/80 h-9 rounded-md px-3">Remove</button>
                                        </div>
