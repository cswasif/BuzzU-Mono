...
export function ProfileModal({ isOpen, onClose, username, avatarSeed }: ProfileModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 sm:p-4">
            ...
            <motion.div
                ...
                className="fixed left-[50%] sm:top-[50%] max-sm:bottom-0 z-[110] w-full translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg md:w-full select-text bg-transparent sm:max-w-[300px] p-0 border-none outline-none overflow-hidden"
            >
                <div className="bg-popover mt-1 sm:-mt-1 rounded-t-lg sm:rounded-lg relative pb-1 max-h-[75vh] overflow-y-auto shadow-2xl">
                    {/* Header/Banner Area */}
                        ...
                        <div className="bg-action rounded-md my-2.5 mx-5 flex items-center justify-center flex-col overflow-y-auto">
                            ...
                            <div className="flex flex-col items-center justify-center px-2 pb-4 w-full">
                                ...
                                <div className="mt-3 w-full flex items-center justify-center rounded-md overflow-hidden">
                                    <button className="inline-flex items-center justify-center text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-4 flex-1 rounded-l-md transition-colors">
                                        Add Friend
                                    </button>
                                    <button className="inline-flex items-center justify-center text-sm font-medium bg-secondary text-secondary-foreground hover:bg-secondary/80 h-9 px-3 rounded-r-md border-l border-primary/10 transition-colors">
