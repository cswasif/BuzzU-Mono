        ...
        >
            <div className="bg-popover relative pb-1 max-h-[75vh] overflow-y-auto">
                <div className="relative">
                            ...
                            <div className="flex flex-col items-center justify-center w-full">
                                ...
                                <div className="w-full flex items-center justify-center rounded-md">
                                    <button
                                        ...
                                        className="inline-flex disabled:select-none items-center justify-center text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-secondary text-secondary-foreground hover:bg-secondary/85 h-9 rounded-md px-3 w-full transition-all duration-200 border border-border/40 hover:border-border/70 hover:shadow-sm hover:-translate-y-[1px]"
                                    >
                                        Edit Profile
                                    </button>
                                </div>
                    ...
                    <div className="pt-2">
                        <div className="bg-action rounded-md py-2.5 my-2.5 mx-5 flex items-center justify-center flex-col px-2 border border-border/35">
                            ...
                            <div className="mt-1 w-full max-w-xs rounded-md bg-panel px-4 py-2 text-center cursor-default max-h-64 overflow-y-auto scrollbar-thin scrollbar-t !px-6 border border-border/35">
                                <div id="parent" className="relative">
                                    <div className="">
                                        {interests.length === 0 ? (
                                            <div className="inline-flex items-center justify-center px-2.5 py-1 text-sm font-medium rounded-full my-2 mr-1 bg-placeholder border border-border/40" color="secondary">No interests</div>
                                        ) : (
                                            interests.map((interest) => (
                                                <div key={interest} className="inline-flex items-center justify-center px-2.5 py-1 text-sm font-medium rounded-full my-2 mr-1 bg-placeholder border border-border/40" color="secondary">{interest}</div>
                                            ))
                                        )}
                                    </div>
                                </div>
